...
// We will use standard PHP mail() function first for simplicity as it often works out of the box on Hostinger
// If they specifically need SMTP/PHPMailer, they must install it. I'll write the script using PHP's native mail() 
// with proper headers which is usually perfectly fine for this use case on Hostinger shared hosting.

$to = "developer@hdlpermacodetech.com";
